    ...
    <header class="header-area">
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html">
                                <img src="assets/images/hope-1.png" width="15%" alt="Logo">
                            </a>
                            ...
                            <div class="navbar-btn d-none d-sm-inline-block">
                                <a class="main-btn" href="{{url('/login')}}">Iniciar Sesión</a>
                            </div>
                        </nav>
                        <!-- navbar -->
                    </div>
        ...
        <div id="home" class="header-hero bg_cover d-lg-flex align-items-center" style="background-image: url(assets/images/header-hero.jpg)">
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="header-hero-content">
                            <h1 class="hero-title wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"><b>Tú</b> <span>Aliado en</span> Casos de <b>Covid-19.</b></h1>
                            <p class="text wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">Nos especializamos en casos de Covid-19, y hacemos que los doctores y personas se sientan Seguros.</p>
                        </div>
                        <!-- header hero content -->
                    </div>
                </div>
            ...
            <div class="header-hero-image d-flex align-items-center wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="1.1s">
                <div class="image">
                    <img src="assets/images/corana4.png" alt="Hero Image">
                </div>
            </div>
            <!-- header hero image -->
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="about-title text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                        <h6 class="welcome">BIENVENIDOS</h6>
                        <h3 class="title"><span>Nosotros contamos con un excelente</span> equipo para el cuidado de los doctores y personas.</h3>
                    </div>
                </div>
            </div>
            <!-- row -->
            <div class="row">
                <div class="col-lg-8">
                    <div class="about-image mt-60 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="assets/images/consultas.jpg" alt="about">
                    </div>
                    <!-- about image -->
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="about-content pt-45">
                        <p class="text wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">Con esta aplicación los doctores va a poder hacer las consultas y el chequeo de los pacientes, sin tener contacto un contacto fisico con estos, así se evitara más pocibles contagios y se salvaran mas vidas.
                        </p>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="single-counter counter-color-3 mt-30 d-flex wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.9s">
                                        ...
                                        <div class="counter-content media-body">
                                            <span class="counter-count"><span class="counter">79.218</span></span>
                                            <p class="text">Contagios Totales</p>
                                        </div>
                                    </div>
                                    <!-- single counter -->
                                </div>
                                <div class="col-sm-4">
                                    <div class="single-counter counter-color-2 mt-30 d-flex wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                                        ...
                                        <div class="counter-content media-body">
                                            <span class="counter-count"><span class="counter">8.496</span></span>
                                            <p class="text">Casos Diarios</p>
                                        </div>
                                    </div>
                                    <!-- single counter -->
                                </div>
                                <div class="col-sm-4">
                                    <div class="single-counter counter-color-1 mt-30 d-flex wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                                        ...
                                        <div class="counter-content media-body">
                                            <span class="counter-count"><span class="counter">10.000</span></span>
                                            <p class="text">Personas Recuperadas</p>
                                        </div>
                                    </div>
                                    <!-- single counter -->
                                </div>
    ...
    <section id="services" class="our-services-area pt-115">
        <div class="container">
            <div class="header-hero-content text-center">
                <h1 class="hero-title wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"><b>Esta es la </b> <span>Mejor Opción</span> para las Consultas Medicas</b>
                </h1>
                <p style="font-size: 20px;">Los siguientes planes son recomendados por nuestros clientes para el resto del publico.</p>
                </br>
            </div>
            <!-- header hero content -->
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-8 col-sm-9">
                    <div class="section-title text-center pb-20 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.2s">
                        <h6 class="sub-title">Nustros planes</h6>
                        <h4 class="title">Estos son nuestros<span>Planes de Trabajo</span></h4>
                    </div>
                    <!-- section title -->
                </div>
            </div>
            ...
            <div class="row no-gutters justify-content-center">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing text-center pricing-active pricing-color-2 mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                        <div class="pricing-price">
                            <span class="price"><b>60</b>/m.<span class="symbol">$</span></span>
                        </div>
                        <div class="pricing-title mt-20">
                            <span class="btn">Special</span>
                            <h4 class="title">Estandar</h4>
                        </div>
                        <div class="pricing-list pt-20">
                            <ul>
                                <li>Full Acceso</li>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing text-center pricing-color-3 mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.9s">
                        <div class="pricing-price">
                            <span class="price"><b>75</b>/m.<span class="symbol">$</span></span>
                        </div>
                        <div class="pricing-title mt-20">
                            <span class="btn">Nuevo</span>
                        ...
                        <div class="pricing-list pt-20">
                            <ul>
                                <li>Full Acceso</li>
                                <li>Ancho de banda Ilimitado</li>
                                <li>100 gb Espacio</li>
                                <li>12 Mes de soporte</li>
                            </ul>
                        </div>
                    </div>
                    <!-- single pricing -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    <div class="section-title text-center pb-20 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                        <h6 class="sub-title">Contactanos</h6>
                        <h4 class="title">A un <span>Click.</span></h4>
                    </div>
                    <!-- section title -->
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-1 mt-30 d-flex  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">Carrera 11 64N 133, San Ignacio <br> Popayan, 19001 Cauca.</p>
                            </div>
                        </div>
                        <!-- single contact info -->
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-2 mt-30 d-flex  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">Ejemplo@gmail.com</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-3 mt-30 d-flex  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.9s">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">+57 313 767 7684</p>
                                <p class="text">+57 305 817 2745</p>
                            </div>
                        </div>
                        <!-- single contact info -->
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact-wrapper-form pt-115  wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <h4 class="contact-title pb-10"><i class="lni-envelope"></i> Envianos <span>Un Mensaje.</span></h4>
    ...
    <footer id="footer" class="footer-area bg_cover" style="background-image: url(assets/images/footer-bg.jpg)">
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 order-sm-3 order-lg-2">
                        <div class="footer-link pt-40">
                            ...
                            <ul>
                                <li><a href="#">Consultas en Casa</a></li>
                                <li><a href="#">Marketing Digital</a></li>
                                <li><a href="#">Analista en Ventas</a></li>
                    ...
                    <div class="col-lg-3 col-sm-6 order-sm-4 order-lg-3">
                        <div class="footer-link pt-40">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Premios y Reconocimietos</a></li>
            ...
            <div class="footer-copyright text-center">
                <p class="text">© 2022 Crafted by <a href="https://uideck.com" rel="nofollow">UIdeck</a> Todos los Dereechos Reservados.</p>
            </div>
        </div>
        <!-- container -->
    </footer>
