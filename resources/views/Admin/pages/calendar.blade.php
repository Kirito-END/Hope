                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="external-events">
                                            <div class="external-event bg-success">Libre</div>
                                            <div class="external-event bg-warning">En revisión</div>
                                            <div class="external-event bg-info">Reunion</div>
                                            <div class="external-event bg-primary">Consulta</div>
                                            <div class="external-event bg-danger">Consulta Pendiente</div>
                                            <div class="checkbox">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="input-group">
                                            <input id="new-event" type="text" class="form-control" placeholder="Nombre del Eveto">
